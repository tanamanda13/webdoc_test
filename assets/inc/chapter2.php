...
<!-- SOUS-PARTIE 10 -->
 <article class="subpart subpart10 sectionId">
    <div class="box__content">
      ...
      <div class="subpart10__main">
        <h1 class="subpart10__title title">DES MONDES<br> INTERCONNECTÉS</h1>
        <span class="subpart10__number title">02</span>
        <span class="subpart10__scroll title">SCROLL</span>
      </div>
    </div>
  </article>
